  ...
  const html = `
    <div class="calculadora-tabela" style="margin: 1.5rem 0; page-break-inside: avoid;">
      ...
      <div style="margin-top: 1rem;">
        ...
        <div style="background-color: #f9fafb; color: #0f172a; padding: 0.75rem; border-radius: 0.375rem; border: 1px solid #0f172a; margin-top: 1rem; page-break-inside: avoid;">
        ...
        <div style="text-align: center; font-size: 0.75rem; color: #6b7280; border-top: 1px solid #e5e7eb; margin-top: 1rem; padding-top: 0.5rem;">
