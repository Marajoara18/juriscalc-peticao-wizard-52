...
const Calculadora = () => {
  ...
  const calcularResultados = () => {
    ...
    try {
      ...
      // Aviso prévio só é devido em caso de dispensa sem justa causa ou rescisão indireta
      ...
      // FGTS incide sobre saldo de salário, aviso prévio e 13º
      const baseCalculoFgts = saldoSalario + avisoPrevia + decimoTerceiro;
      const fgts = baseCalculoFgts * 0.08;
      
      // Multa de 40% do FGTS só é devida em caso de dispensa sem justa causa ou rescisão indireta
